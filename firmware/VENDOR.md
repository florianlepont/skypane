...
- `main/secrets.example.h` — a new file this project introduces; upstream
  ...
  four `INK_`-prefixed macros this phase's `wifi.c`/`api_client.c` read:
  `INK_WIFI_SSID`, `INK_WIFI_PASS`, `INK_API_BASE`, `INK_SETUP_SECRET`.
