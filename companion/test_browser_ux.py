...
from companion.test_browser_ux_helpers import (  # noqa: E402
    ...
    _commit_field, _computed_paint, _display_page_height, _drop_files,
    _expected_quiet_duration_text, _guard_armed, _handle_sel, _hit_area,
    _in_both_themes, _login, _no_js_page, _operate_with_keyboard,
    _persist_without_js, _quiet_arc_minutes, _quiet_caption_minutes,
    _quiet_caption_shape, _quiet_duration_span_text, _save_via_bar,
...
# with the rest of this file. 96 - 11 = 85, re-derived by RUNNING the
# reduced file (85/85, 0 SKIPs), never by subtracting on paper.
EXPECTED_CHECK_COUNT = 85
            ...
            try:
                ...
                def _keying_the_strip_selects_scrolls_into_view_and_moves_the_preview():
                    ...
                    try:
                        ...
                        if restored != saved:
                            return False, (
                                "this check left the stored theme at %r; it started at %r"
                                % (restored, saved))
                        _ = recorded
                        return True, ""
                    finally:
