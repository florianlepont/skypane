...
from companion.test_browser_ux_helpers import (  # noqa: E402
    ...
    _guard_armed, _handle_sel, _in_both_themes, _login, _no_js_page, _operate_with_keyboard,
    _persist_without_js, _quiet_arc_minutes, _save_via_bar,
...
# runnable harness, so the suite's worker pool can run it concurrently
# with the rest of this file. 85 - 9 = 76, re-derived by RUNNING the
# reduced file (76/76, 0 SKIPs), never by subtracting on paper.
