...
helpers and for the Health page
(companion/pages/health_page.py). Every key is the exact English
source string a call site passes to companion.i18n.t()/t_lang(),
including any "%d"/"%s"/"%%" placeholder. A handful of keys (e.g.
"Resolve", "Count") are shared by more than one call site on the
Health page — one catalogue entry, several readers.
