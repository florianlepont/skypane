...
EXPECTED_CHECK_COUNT = 279  # 317 - 38 (33-25: part 01's 37 checks plus the
# pulled-forward anomaly_active() degrade-safely check), re-derived by
# RUNNING (279/279 pass).
