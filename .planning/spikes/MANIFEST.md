...
| 003 | diagonal-band-theme | comparison | A new theme adding a diagonal decorative band behind the aircraft illustration, reproducing a developer-supplied poster reference within the real 6-ink constraint | VALIDATED — 15 rounds of iteration, developer confirmed the final composition ("oui !"); see Requirements below for the full confirmed decision set | render, theme, diagonal-band, layout, e-ink, typography, palette-guard-rail |
