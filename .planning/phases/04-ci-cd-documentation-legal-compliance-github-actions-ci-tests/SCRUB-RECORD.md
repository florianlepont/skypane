...
If this rewrite is ever found to be incomplete or wrong, the pre-rewrite history is fully recoverable from the verified bundle at the path recorded above (`git clone <bundle-path> <restore-dir>`), which predates any object pruning.
