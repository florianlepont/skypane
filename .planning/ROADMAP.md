...
- [ ] 12-01-PLAN.md — `display_enabled` registry field (D-08/D-09) and the `DISPLAY_OFF_SLEEP_S = 300` constant (D-01) in `server/device_config.py`
- [ ] 12-02-PLAN.md — the DISPLAY OFF panel render state with its locked no-return-time copy (D-03/D-04)
