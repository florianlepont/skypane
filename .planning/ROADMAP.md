...
- [x] 35-07-PLAN.md — Wave 4 — group 3 stub-server/ purge and close (HYG-01, HYG-03)
- [x] 35-08-PLAN.md — Wave 5 — companion app.py, auth.py and small modules (HYG-01)
- [x] 35-09-PLAN.md — Wave 5 — companion pages/config_page.py (HYG-01)
- [x] 35-10-PLAN.md — Wave 5 — companion health and history pages (HYG-01)
- [x] 35-11-PLAN.md — Wave 5 — companion layout.py and draw.py (HYG-01)
