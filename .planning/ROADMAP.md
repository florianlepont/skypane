...
Plans:
- [ ] 21-01: Simple mode removed — prefs, cookie, route, nav switch, every gate (wave 1)
- [ ] 21-02: Health "Pause updates" button and freshness.js pause branch removed (wave 2)
- [ ] 21-03: Compact Flights table, detail row, flight-rows.js (wave 2)
- [ ] 21-04: Frame strip, nav state reminder, Home rebuilt (wave 3)
- [ ] 21-05: One "Frame colours" view and the empty-string clear signal (wave 4)
- [ ] 21-06: Artwork upload restored in the resolve flow (wave 4)
- [ ] 21-07: Calendar in one tile — masked URL, replace link, small grey Disconnect (wave 5)
- [ ] 21-08: Closing — design-system skill, FR/EN sweep, suite + ruff gate, validation map (wave 6)
