...
- [x] 32-04-PLAN.md — migrate manual_resolutions (root-safe), colour_rules, enrich
...
- [x] 32-09-PLAN.md — migrate render
- [x] 32-10-PLAN.md — migrate poll_loop
- [x] 32-11-PLAN.md — /poll-now checks on the fake provider; shim runs every companion harness under the network guard
...
- [x] 33-02-PLAN.md — pytest-playwright lock, shared app-server fixture/support module, missing-browser policy, loopback browser guard (W1)
- [x] 33-03-PLAN.md — Structural HTML/CSS/JS helpers, TST-10/12/13/14 AST guard, disk-derived legacy set (W1)
...
- [x] 33-26-PLAN.md — status_pages part 02 (W3)
...
- [x] 33-21-PLAN.md — browser_ux part 01; aspect-repin self-read deleted (W4)
- [x] 33-27-PLAN.md — status_pages part 03 (W4)
...
- [x] 33-28-PLAN.md — status_pages part 04 — .planning/ticket-ID reads deleted (W5)
...
- [x] 34-04-PLAN.md — Kconfig/sdkconfig (TWDT panic, DHCP, memtest, rollback, ISRG-only bundle), secret partition, production-config check in CI
- [x] 34-05-PLAN.md — git-describe PROJECT_VER, prod/dev/fault build profiles, firmware/provision.sh
- [x] 34-06-PLAN.md — api_client: 401/403 token erase, per-device secret enrolment, https gate, checked returns, dead code, dedup
...
**Plans:** 22 plans (13 waves, one PR per directory group)
...
- [ ] 35-01-PLAN.md — Wave 1 — group 1 foundation: gate G-33, `scripts/check_comment_history.py` (check / ratio / same-code), mutation-proven guard with a ratchet list, CI step, baseline, English-only rule (HYG-04, HYG-06)
...
- [ ] 35-10-PLAN.md — Wave 5 — companion health and history pages (HYG-01)
- [ ] 35-11-PLAN.md — Wave 5 — companion layout.py and draw.py (HYG-01)
- [ ] 35-12-PLAN.md — Wave 5 — companion airlines/home pages, pages/__init__.py, i18n_fr comments only (HYG-01)
- [ ] 35-13-PLAN.md — Wave 6 — HYG-05 dead code (re-checked on main) + close group 4 (HYG-05, HYG-01)
- [ ] 35-14-PLAN.md — Wave 7 — companion browser test family (HYG-01)
...
- [ ] 35-19-PLAN.md — Wave 10 — group 7 style.css purge by section, shipped size raw/gzip before/after (HYG-02)
- [ ] 35-20-PLAN.md — Wave 11 — group 8 deploy/, scripts/, .github/, root config, adsb-test/, hardware/ (HYG-03, HYG-01)
- [ ] 35-21-PLAN.md — Wave 12 — group 9 firmware behind gate G-34; SPDX/Apache headers and VENDOR.md provenance kept (HYG-03)
