...
**Depends on:** Phase 21
**Plans:** 16 plans in 12 dependency waves (ordered by what must exist before what, never by calendar — D-11)

Plans:
- [ ] 22-01-PLAN.md — B1 blocker: document-level dirty-state delegation, the fallback-Save contract, T1/T8, and the Playwright harness (wave 1)
