...
#
# Runs all 19 harnesses under coverage, aggregates the result, and enforces
...
# Canonical 19-file enumeration (M1, measured live during 04-02 planning;
...
# server/test_manual_resolutions.py; phase 14 plan 01 added the new
# colour-rules harness below; phase 16 plan 01 added the calendar-rules
# harness below it). 04-CONTEXT.md's D-07 list is 7 files and is
# known-stale — do NOT "correct" this list back down to match it. This
# array is the single source of truth CI (04-04) and README.md (04-05)
# both defer to.
HARNESSES=(
